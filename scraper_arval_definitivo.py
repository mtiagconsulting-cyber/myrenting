...
async def main():
    print("Iniciando scraper Arval (empresas + particulares)...")
    ...
    async with async_playwright() as p:
        ...
        empresas = await scrape_paginas(
            page,
            "https://www.arval.es/ofertas/renting-empresas-largo-plazo",
            "empresa"
        )
        
        particulares = await scrape_paginas(
            page,
            "https://www.arval.es/ofertas/renting-particulares-largo-plazo",
            "particular"
        )
