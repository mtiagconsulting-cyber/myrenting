...
OUTPUT_JSON = os.path.join(BASE_DIR, "ofertas-db.json")
...
async def main():
    ...
    # La inyeccion en la web la hace actualizar_ofertas_seguro.py (con guardarrailes:
    # preserva gestoras no scrapeadas, fallback por gestora, validacion y rollback).
    # Aqui solo dejamos ofertas-db.json actualizado.
    print(f"\n✅ Scrape completado: {len(todas)} ofertas en {OUTPUT_JSON}")
    print("   Siguiente paso: python3 actualizar_ofertas_seguro.py")
