...
const q = (data) => ({ provider: "Quadis Empresas", audiences: ["particular", "autonomo", "empresa"], coverage: quadisCoverage, source_document: "BROKERS 08.09.2026.pdf", ...data });
...
const offers = [
  ...
  q({ brand:"Honda", model:"CR-V", version:"2.0 i-MMD PHEV 4x2 Elegance Tech", fuel:"Híbrido enchufable", transmission:"Automático", power_cv:184, emissions_label:"CERO", colors:["Negro Cristal","Blanco Diamond Dust","Gris Urban Perlado"], availability:"Negro y gris en stock; blanco previsto en octubre", data_note:"Las cuotas de la parrilla corresponden al color Negro Cristal. Blanco y Gris llevan un suplemento de 4 €/mes.", prices:rows(km5,[36,48,60],[[442,460,465],[473,487,488],[503,514,513],[542,550,551],[580,591,589]],[[535,557,563],[572,589,590],[609,622,621],[656,666,667],[702,715,713]]) }),
  ...
  q({ audiences:["autonomo","empresa"], brand:"Peugeot", model:"Boxer", version:"Furgón L2 H2 3,3T Diésel 103kW (140CV)", fuel:"Diésel", transmission:"Manual", power_cv:140, emissions_label:"C", colors:["Blanco"], availability:"Stock hasta fin de existencias; campaña válida solo durante septiembre", data_note:"Exclusivo para autónomos y empresas. Excluido del servicio público; requiere cotización aparte.", prices:rows(km5,[48,60],[[405,392],[431,417],[456,450],[487,482],[514,514]],[[490,474],[522,505],[552,545],[589,583],[622,622]]) }),
];
...
const payload = { generated_at:new Date().toISOString(), image_policy:"No contiene imágenes ni URLs de imágenes", ended_campaigns:[
  ...
  {brand:"Skoda",model:"Fabia",external_id:"520823",reason:"Campaña finalizada en la actualización de 08.09.2026"},
], replaced_catalog_external_ids:["493813","514005","514117","523377","515717","523298","522422","523390","520823"], offer_count:offers.length, price_combination_count:offers.reduce((sum, offer) => sum + offer.prices.length, 0), offers };
