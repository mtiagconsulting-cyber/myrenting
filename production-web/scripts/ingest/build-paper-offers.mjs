...
const q = (data) => ({ provider: "Quadis Empresas", audiences: ["particular", "autonomo", "empresa"], coverage: quadisCoverage, source_document: "BROKERS 10.08.2026.pdf", ...data });
...
const offers = [
  ...
  q({ brand:"Opel", model:"Corsa", version:"1.2T XHL 74kW (100CV) GS", fuel:"Gasolina", transmission:"Manual", power_cv:100, emissions_label:"C", seats:5, colors:["Karbon Black","Grafik Grey"], availability:"Agosto", prices:rows(km5,[48,60],[[257,245],[271,261],[289,285],[311,307],[330,329]],[[311,296],[328,316],[350,345],[376,371],[399,398]]) }),
  q({ brand:"Peugeot", model:"208", version:"Allure Gasolina 100 S&S 6 Vel. Manual Turbo", fuel:"Gasolina", transmission:"Manual", power_cv:100, emissions_label:"C", seats:5, colors:["Blanco Okenite"], availability:"Entrega agosto", prices:rows(km5,[48,60],[[252,243],[267,259],[285,282],[307,304],[325,326]],[[305,294],[323,313],[345,341],[371,368],[393,394]]) }),
  ...
  q({ brand:"MG", model:"ZS", version:"Hybrid+ Business", fuel:"Híbrido gasolina", transmission:"Automático", power_cv:197, emissions_label:"ECO", colors:["Plata"], availability:"Septiembre", prices:rows([10000,15000,20000],[48,60],[[308,305],[332,329],[359,368]],[[373,369],[402,398],[434,445]]) }),
  ...
  q({ audiences:["particular","autonomo"], campaign:"Modelo anterior — 100 € combustible", brand:"Kia", model:"Niro", version:"1.6 GDi HEV 102kW (139CV) Drive", fuel:"Híbrido gasolina", transmission:"Automático", power_cv:139, emissions_label:"ECO", colors:["Clear White (sólido)"], availability:"Stock hasta fin de existencias; regalo de 100 € de combustible", prices:rows(km5,[36,48,60],[[316,312,307],[333,328,322],[350,343,336],[372,364,358],[395,385,379]],[[382,378,371],[403,397,390],[424,415,407],[450,440,433],[478,466,459]]) }),
  q({ provider:"Quadis Empresas — AYVENS", campaign:"AYVENS — MY27", brand:"Kia", model:"Niro", version:"1.6 GDi HEV 101,5kW (138CV) Drive MY27", fuel:"Híbrido gasolina", transmission:"Automático", power_cv:138, emissions_label:"ECO", colors:["Snow White Pearl (metalizado)"], availability:"Entrega prevista en septiembre", prices:rows(km5,[36,48,60],[[324,320,315],[341,336,322],[359,351,345],[381,372,366],[404,395,388]],[[392,387,381],[413,407,390],[434,425,417],[461,450,443],[489,478,469]]) }),
...
const payload = { generated_at:new Date().toISOString(), image_policy:"No contiene imágenes ni URLs de imágenes", ended_campaigns:[{brand:"MG",model:"MG3",external_id:"515717",reason:"Campaña finalizada en la actualización de 10.08.2026"}], replaced_catalog_external_ids:["493813","514005","514117","523377","515717","523298"], offer_count:offers.length, price_combination_count:offers.reduce((sum, offer) => sum + offer.prices.length, 0), offers };
