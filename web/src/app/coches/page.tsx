...
import { sortedByPrice } from "@/lib/data";
export const metadata = { title: "Renting de coches en España — 63 modelos comparados", description: "Compara 63 modelos de renting de 3 gestoras. Filtra por combustible, etiqueta y carrocería. Cuotas reales, sin entrada." };
...
export default function Coches() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-6">
      ...
      <div className="bg-white border border-line border-l-[3px] border-l-orange rounded-xl2 px-4.5 py-3.5 text-[15px] text-ink mt-3.5 max-w-[74ch]">Comparamos <b>63 modelos</b> de 3 gestoras. Cuotas reales, con seguro y mantenimiento incluidos y sin entrada.</div>
      <div className="grid md:grid-cols-[250px_1fr] gap-6 items-start mt-5">
        ...
        <div>
          <div className="flex justify-between mb-3.5 text-sm text-muted"><span><b className="text-ink">63</b> coches · 190 ofertas</span><span>Ordenar: <b className="text-ink">precio ↑</b></span></div>
          {list.map(v=>(
